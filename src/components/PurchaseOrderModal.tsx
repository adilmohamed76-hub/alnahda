                                    ...
                                    {poData.items.map((item, index) => {
                                      ...
                                      return (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-2 text-center"><button type="button" onClick={() => removeItem(index)} className="p-1 text-red-500" aria-label={`حذف ${item.productName}`}><TrashIcon /></button></td>
                                        </tr>
                                    )})}
                                </tbody>
                            </table>
                            ...
                            <div className="space-y-2">
                                {(poData.expenses || []).map((exp, index) => (
                                    <div key={index} className="flex items-center gap-2">
                                        ...
                                        <button type="button" onClick={() => removeExpense(index)} className="p-1 text-red-500" aria-label={`حذف المصروف ${exp.description}`}><TrashIcon /></button>
                                    </div>
                                ))}
                            </div>
                        </div>
