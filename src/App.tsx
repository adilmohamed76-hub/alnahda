...
import FeasibilityStudyManagement from './components/FeasibilityStudyManagement';


// Import Icons
import { UsersIcon, ShoppingCartIcon, DollarSignIcon, ArchiveIcon } from './components/Icons';
...
const App: React.FC = () => {
 ...
 const handleLogin = async (username: string, password?: string) => {
    try {
        const { user, token } = await apiService.authenticateUser(username, password || '');
  ...
  return (
    <div className="flex h-screen bg-[var(--background-light)] dark:bg-[var(--background-dark)]">
      <Sidebar 
