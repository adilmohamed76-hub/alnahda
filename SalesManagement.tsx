                                        ...
                                        <tr key={so.id} className={`border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 ${isReturn ? 'bg-red-50 dark:bg-red-900/20' : 'bg-white dark:bg-gray-800'}`}>
                                            ...
                                            <td className="px-6 py-4 text-center">
                                                <div className="flex justify-center items-center gap-2">
                                                  <button onClick={() => setInvoiceToPrint(so)} className="p-2 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-900/50 rounded-full" title="طباعة الفاتورة">
                                                      <PrinterIcon />
                                                  </button>
                                                  {hasPermission('MANAGE_SALES_ORDERS') && (
                                                    <>
                                                      <button onClick={() => handleOpenEditModal(so)} className="p-2 text-blue-500 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-full"><PencilIcon /></button>
                                                      <select 
                                                        value={so.status} 
