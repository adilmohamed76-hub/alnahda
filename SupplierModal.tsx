...
import type { Supplier, BankAccount, Currency } from './types';
            ...
            <div className="space-y-3">
              {formData.bankAccounts.map((account, index) => (
                <div key={index} className="grid grid-cols-1 md:grid-cols-7 gap-2 items-end p-3 bg-gray-100 dark:bg-gray-900/50 rounded-lg">
                  ...
                  <div>
                     <button type="button" onClick={() => removeBankAccount(index)} className="w-full p-2 text-red-500 hover:bg-red-100 dark:hover:bg-red-900/50 rounded-md">
                        <TrashIcon />
                    </button>
                  </div>
                </div>
