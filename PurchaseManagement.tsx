                                    ...
                                    <td className="px-6 py-4 text-center">
                                        <div className="flex justify-center items-center gap-2">
                                            {hasPermission('MANAGE_PURCHASE_ORDERS') && 
                                              <>
                                                <button onClick={() => handleOpenEditModal(po)} className="p-2 text-blue-500 hover:bg-blue-100 dark:hover:bg-blue-900/50 rounded-full" title="تعديل"><PencilIcon /></button>
                                                {po.status === 'تم الاستلام' && hasPermission('CREATE_FEASIBILITY_STUDIES') && (
                                                    <button onClick={() => onCreateFeasibilityStudy(po)} className="p-2 text-yellow-500 hover:bg-yellow-100 dark:hover:bg-yellow-900/50 rounded-full" title="إنشاء دراسة جدوى">
                                                        <LightbulbIcon />
                                                    </button>
                                                )}
                                              </>
